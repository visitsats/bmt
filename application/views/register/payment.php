	...
	<label class="form-lable ">State<span class="star">*</span></label>	
		...
		<div class="form-group col-md-6" id="as_no">
		 ...
		 <?php } ?>
		  <div class="form-group col-md-6">
			1 Reward Point =	&nbsp;&nbsp;
			<input type="number" name="reward" id="reward"  value="<?php echo $userdata['rewards_bill']?>" /> 
		 </div>		  
								...
								<div class="price-plans-payment">
									...
									<div class="col-xs-6 pp-divider">
										<div class="radio radio-success">
											...
											<label for="l_i_Annual text-wight"> 
												<h5>Monthly</h5>
												<div class="price"><i class="fa fa-dollar" aria-hidden="true"></i>19</div>
												<p><i class="fa fa-dollar" aria-hidden="true"></i>19 month/user</p>
											</label>
										</div>
									</div>
									<div class="col-xs-6">
										<div class="radio radio-success">
											...
											<label for="l_i_Annual text-wight">
												<h5>Annual</h5>
												<div class="price"><i class="fa fa-dollar" aria-hidden="true"></i>180</div>
									...
									<div class="col-xs-6 pp-divider">
										<div class="radio radio-success">
											...
											<label for="l_i_Annual text-wight"> 
												<h5>Monthly</h5>
												<div class="price"><i class="fa fa-dollar" aria-hidden="true"></i>29</div>
												<p><i class="fa fa-dollar" aria-hidden="true"></i>29 month/user</p>
											</label>
										</div>
									</div>
									<div class="col-xs-6">
										<div class="radio radio-success">
											...
											<label for="l_i_Annual text-wight">
												<h5>Annual</h5>
												<div class="price"><i class="fa fa-dollar" aria-hidden="true"></i>300</div>
									...
									<div class="col-sm-12 col-xs-12">
										<div class=" card-details-panel">
											...
											<div class=" card-details-cnt">
												...
												<div class="col-xs-4">
													<input name="cvv" id="cvv"  placeholder="cvv/cvc" value="" class="form-control" type="password">
												</div>
												<div class="col-xs-12">
