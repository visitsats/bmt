      ...
      <div class="row">
        ...
        <div class="wrap mnone">
          <div class="col-xs-12 col-sm-12 col-md-8 col-md-offset-2"> 
			...
			<form name="" method="post" class="wrap mt15" action="<?php echo base_url()."bookmyt/create_branch_pwd/".$uid; ?>">
				...
				<label class="form-lable ">Confirm New Password<span class="star">*</span></label>
				  ...
				  <button type="submit" name="sub" onclick="return valid()" class="btn btn-success pull-right mt25">Save and Login</button> </div>
