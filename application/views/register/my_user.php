        ...
        <div class="wrap mnone">
          <div class="col-xs-12 col-sm-12 col-md-8 col-md-offset-2"> 
			...
			<?php
				...
				{
			?>
            <form name="" method="post" role="form" class="wrap mt15" action="<?php echo base_url()."bookmyt/update_my_user/".$user_data->user_id; ?>">
			...
			<?php
				...
				if($this->session->userdata('branch') && $this->session->userdata('branch') == '0')
				{
				...
				?>
				   <div class="form-group col-xs-12 col-sm-6 col-md-6"> 
				    <label class="form-lable ">Name<span class="star">*</span></label>
						<input type="text" placeholder="" maxlength="25" class="form-control" value="<?php echo $user_data->username; ?>" name="username" id="username">
				...
				<div class="form-group col-xs-12 col-sm-6 col-md-6">
				 ...
				 <div class="form-group col-xs-12 col-sm-6 col-md-6 pull-right mt25">
				  <a href="<?php echo base_url().'bookmyt/users/'; ?>" class="btn btn-success pull-right" style="margin-left:5px">Cancel</a>
...
<script type="text/javascript">
	function validate()
	{
		...
		if(error.length != 0)
		{
			...
			if($.inArray("e2", error) !== -1){ alert("Please enter User Name"); $("#username").addClass('error');} else {$("#username").removeClass('error'); }
			if($.inArray("e3", error) !== -1){alert("Plese enter either Email or Phone Number"); $("#email_chk").addClass('error');} else { $("#email_chk").removeClass('error'); }
