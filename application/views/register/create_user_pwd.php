      ...
      <div class="row">
        ...
        <div class="wrap mnone">
          <div class="col-xs-12 col-sm-12 col-md-8 col-md-offset-2"> 
			...
			<form name="" method="post" class="wrap mt15" action="<?php echo base_url()."bookmyt/create_user_pwd/".$uid; ?>">
            
				<div class="form-group col-md-4"><label class="form-lable ">Old Password<span class="star">*</span></label>
				...
				<label class="form-lable ">Confirm New Password<span class="star">*</span></label>
				  ...
				  <button type="submit" name="sub" onclick="return valid()" class="btn btn-success pull-right">Save and Login</button> 
				  </div>
