			 ...
			 <nav class="pull-left mnav-close ">
			  <ul class="list-unstyled ">
				...
				<li><a href="<?php echo base_url('bookmyt/demo'); ?>">Demo</a></li>	
					 ...
					 <a data-toggle="modal" data-target="#login-modal" id="modal-launcher" class="btn btn-default" href="#">Login</a> <a  class="btn btn-success signup" href="<?php echo base_url('bookmyt/signup'); ?>">Signup</a> </div>
...
?>
<section class="topPanel  single-page-nav <?php if($this->session->userdata('business_id') || in_array($cur_method,$open_mtds)) { echo " top-panel-inner2"; } ?>">
  <div class="container">
    <div class="row">
 ...
 <a href="#" class="btn btn-default pull-right m-nav-control hidden-sm hidden-md hidden-lg" > <i class="fa fa-bars"></i></a></div>
	...
	?>
      ...
      <div class="col-sm-10 col-md-10 hidden-xs main-nav main-nav-inner">
        <nav class="pull-left">
		  <ul class="list-unstyled">
		  	<li <?php if(in_array($current_method,$occupancy)) { echo "class='active'"; } else {} ?> ><a href="<?php echo base_url();?>bookmyt/occupancy"><img src="<?php echo base_url(); ?>theme/images/reservations.png" alt=""> <span class="clearfix"></span>
			  Occupancy</a></li>
		  <?php
			if($this->session->userdata('branch') != 1)
			{
				...
				else
				{
					...
					{
			?>
				<li <?php if(in_array($current_method,$branch_methods)) { echo "class='active'"; } else {} ?> ><a href="<?php echo base_url();?>bookmyt/branches"><img src="<?php echo base_url(); ?>theme/images/branches.png" alt=""><span class="clearfix"></span>Branches </a></li>
			<?php
					}
				}
			}
			...
			<li <?php if(in_array($current_method,$floor_methods)) { echo "class='active'"; } else {} ?> ><a href="<?php echo base_url();?>bookmyt/floors"> <img src="<?php echo base_url(); ?>theme/images/floors.png" alt=""><span class="clearfix"></span>
			  Floors </a></li>
			  <?php } ?>
				<?php
				...
				{
				?>
				<li <?php if(in_array($current_method,$users_methods)) { echo "class='active'"; } else {} ?> ><a href="<?php echo base_url();?>bookmyt/users"> <img src="<?php echo base_url(); ?>theme/images/users.png" alt=""><span class="clearfix"></span>
				Users </a></li>
				<?php				
				}
				}else
			...
			<li <?php if(in_array($current_method,$reservation_methods)) { echo "class='active'"; } else {} ?> ><a href="<?php echo base_url();?>bookmyt/reservation_list"><img src="<?php echo base_url(); ?>theme/images/reservations.png" alt=""> <span class="clearfix"></span>
			  Reservations</a></li>
			   <li <?php if(in_array($current_method,$quick_book)) { echo "class='active'"; } else {} ?> ><a href="<?php echo base_url();?>bookmyt/quick_book"><img src="<?php echo base_url(); ?>theme/images/walkin.png" alt=""> <span class="clearfix"></span>
			  Walkin</a></li>
			  <?php
				if(!empty($this->permissions))
				{
		...
		<?php
			...
			<img src="<?php echo base_url(); ?>theme/images/ios-app.png" >
			 ...
			 <a href="#" class="btn btn-default login_pwd" id="modal-launcher"  data-target="#login-modal" data-toggle="modal">Login</a> <a href="<?php echo base_url('bookmyt/signup'); ?>" class="btn btn-success signup" >Signup</a> </div>
    ...
    <div class="container">
      <div class="row">
       ...
       <a href="https://www.facebook.com/BookmyT-607569296119448/" target="_blank"> <span class="fa fa-facebook"></span></a>
        ...
        <a href="https://www.linkedin.com/company/13336638/admin/updates/"> <span class="fa fa-linkedin"></span></a>
      ...
      <div class="modal-body login-modal">
       <!-- <p>Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard dummy text eve</p> -->
        ...
        <div id='social-icons-conatainer'>
		  ...
		  <form name="login" method="post" action="<?php echo base_url();?>bookmyt/login_action">
