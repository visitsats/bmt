...
abstract class REST_Controller extends KM_Controller
{
	/**
	...
	*/
	...
	protected function _detect_output_format()
	{
		...
		if (isset($this->_get_args['format']) AND $this->_get_args['format'] AND array_key_exists($this->_get_args['format'], $this->_supported_formats))
		{
