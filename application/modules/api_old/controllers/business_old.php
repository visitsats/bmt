...
class Business extends REST_Controller
{
	...
	*/ 
	...
	public function floorslist_post()
	{
	 ...
	 $business_id=$this->input->post('business_id');
	  $data['floors_list']= $this->users_model->get_floors_list($business_id);
	  $this->response($data, 200);
	...
	*/ 
	...
	public function tableslist_post()
	{
	 ...
	 $business_id=$this->input->post('business_id');
	 $floor_id=$this->input->post('floor_id');
	  $data['tables_list']= $this->users_model->get_tables_list($business_id,$floor_id);
	  $this->response($data, 200);
	...
	*/ 
    ...
    public function reservationlist_post()
	{
	 ...
	 $business_id=$this->input->post('business_id');
	  $data['reservation_list']= $this->users_model->reservation_list($business_id);
	  $this->response($data, 200);
