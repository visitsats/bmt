        ...
        var tpl = {
            ...
            "emphasis":
                "<li>" +
                  "<div class='btn-group'>" +
                    ...
                    "<a class='btn' data-wysihtml5-command='insertOrderedList' title='" + locale.lists.ordered + "' style='height:20px;'><i class='icon_number'></i></a>" +
					
					  "<div class='bootstrap-wysihtml5-insert-link-modal modal hide fade' style='width:35%;'>" +
				  ...
				  "<div class='bootstrap-wysihtml5-insert-image-modal modal hide fade' style='width:35%;'>" +
                    "<div class='modal-header'>" +
                      "<a class='close' data-dismiss='modal'>&times;</a>" +
            ...
            "lists":
                "<li>" +
                  "<div class='btn-group'>" +
                    "<a class='btn' data-wysihtml5-command='insertUnorderedList' title='" + locale.lists.unordered + "'><i class='icon-list'></i></a>" +
                    "<a class='btn' data-wysihtml5-command='insertOrderedList' title='" + locale.lists.ordered + "'><i class='icon_number'></i></a>" +
